...
echo _gettext("Search");
    ...
    <div";
        // line 34
        echo (( !twig_test_empty((isset($context["items"]) || array_key_exists("items", $context) ? $context["items"] : (function () { throw new RuntimeError('Variable "items" does not exist.', 34, $this->source); })()))) ? (" class=\"ms-2\"") : (""));
        echo ">
  ...
  <form id=\"rteListForm\" class=\"ajax\" action=\"";
    ...
    <div id=\"nothing2display\"";
        // line 44
        echo (( !twig_test_empty((isset($context["items"]) || array_key_exists("items", $context) ? $context["items"] : (function () { throw new RuntimeError('Variable "items" does not exist.', 44, $this->source); })()))) ? (" class=\"hide\"") : (""));
        echo ">
      ";
        // line 45
    ...
    <table id=\"routinesTable\" class=\"table table-striped table-hover";
        // line 48
        echo ((twig_test_empty((isset($context["items"]) || array_key_exists("items", $context) ? $context["items"] : (function () { throw new RuntimeError('Variable "items" does not exist.', 48, $this->source); })()))) ? (" hide") : (""));
        echo " data w-auto\">
      <thead>
      <tr>
        <th></th>
